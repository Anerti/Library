...
echo "── 4) 403 — DELETE /libraries/{uuid} (customer token)  →  403 / forbidden"
curlie -H "Authorization:Bearer $CUSTOMER_TOKEN" DELETE "http://localhost:8080/libraries/51d81748-207c-4a67-b3bc-9434634bbad5"
echo
