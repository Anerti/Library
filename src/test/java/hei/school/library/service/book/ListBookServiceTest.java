...
class ListBookServiceTest {
  ...
  void listBooks_shouldReturnPaginatedBooks() {
    ...
    PageResponse<BookResponse> result =
        bookService.listBooks(null, null, null, null, 1, 20);
  ...
  void listBooks_shouldFilterBySearch() {
    ...
    PageResponse<BookResponse> result =
        bookService.listBooks("Petit", null, null, null, 1, 20);
  ...
  void listBooks_shouldFilterByGenreName() {
    ...
    PageResponse<BookResponse> result =
        bookService.listBooks(null, null, null, "Fiction", 1, 20);
  ...
  void listBooks_shouldUsePageAndSize() {
    ...
    PageResponse<BookResponse> result =
        bookService.listBooks(null, null, null, null, 3, 10);
