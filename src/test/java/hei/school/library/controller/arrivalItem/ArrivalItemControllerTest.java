...
public class ArrivalItemControllerTest {
    ...
    @MockBean
    private ArrivalItemService arrivalItemService;
    ...
    void setUp() {
        ...
        arrivalItemResponse = ArrivalItemResponse.builder()
                .arrivalId(arrivalId)
    ...
    void findByArrivalId_shouldReturn200() throws Exception {
        when(arrivalItemService.findByArrivalId(arrivalId))
                .thenReturn(List.of(arrivalItemResponse));

        mockMvc.perform(get("/arrivals/{arrivalId}/items", arrivalId))
    ...
    void findByArrivalId_shouldReturn404_whenArrivalNotFound() throws Exception {
        when(arrivalItemService.findByArrivalId(arrivalId))
                .thenThrow(new NotFoundException(
                        "Arrival with id " + arrivalId + " not found"));
    ...
    void create_shouldReturn201() throws Exception {
        ...
        mockMvc.perform(post("/arrivals/{arrivalId}/items", arrivalId)
    ...
    void delete_shouldReturn204() throws Exception {
        ...
        mockMvc.perform(delete("/arrivals/{arrivalId}/items/{bookCopyId}",
                        arrivalId, bookCopyId))
    ...
    void delete_shouldReturn404_whenNotFound() throws Exception {
        doThrow(new NotFoundException(
                "ArrivalItem not found for arrival " + arrivalId
                        + " and bookCopy " + bookCopyId))
                .when(arrivalItemService).delete(arrivalId, bookCopyId);
