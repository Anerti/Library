...
class AuthControllerTest {
  ...
  void register_shouldReturn201() throws Exception {
    when(authService.create(any(UserRequest.class))).thenReturn(userResponse);
    ...
    mockMvc
        ...
        .andExpect(jsonPath("$.user.phone").value("+26134566789"));
  }
  ...
  void register_shouldReturn409_whenDuplicateEmail() throws Exception {
    when(authService.create(any(UserRequest.class)))
